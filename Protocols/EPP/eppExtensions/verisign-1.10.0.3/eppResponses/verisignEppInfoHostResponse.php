...
/**
 * Class verisignEppInfoHostResponse
 * @package Guanjia\EPP
 */
class verisignEppInfoHostResponse extends verisignBaseResponse
{
    /**
     *
     ...
     * @return null|string
     */
    public function getHostTransferDate() {
        return $this->queryPath('/epp:epp/epp:response/epp:resData/host:infData/host:trDate');
    }
